...
function Root() {
  ...
  function submit() {
    ...
    setTimeout(() => {
      setError(secretWord.toLowerCase() !== 'layton')
      setSubmitCount((value) => value + 1)
      setIsPending(false)

      if (secretWord.toLowerCase() === 'layton') {
        window.location.href = generateRoutePath(RoutePath.SECOND, {})
      }
    }, 2700)
  }
    ...
    <Layout>
      <>
        <Container>
          ...
          <p>Entre le premier mot secret</p>
